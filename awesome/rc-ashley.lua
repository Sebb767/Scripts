...
-- other widgets
dofile "/home/sebb/.config/awesome/widgets.lua"
...
globalkeys = awful.util.table.join(
  ...
  awful.key({ "Shift" }, "Print", function () awful.util.spawn("scrot '%Y-%m-%d_%H:%M:%S_$wx$h.png' -u -e 'mv $f ~/screenshots/ 2>/dev/null'") end),
...
wp_timer:connect_signal("timeout", function()
  ...
  for s = 1, screen.count() do
    ...
    local f = io.popen("sh -c \"find ~/wallpapers -name '*.png' -o -name '*.jpg' | shuf -n 1 | xargs echo -n\"")
...
--awful.util.spawn_with_shell("xmodmap -e 'keysym Caps_Lock = Super_L''")
--awful.util.spawn_with_shell("nemo --no-desktop -n")
--awful.util.spawn_with_shell("/home/sebb/.dropbox-dist/dropboxd")
